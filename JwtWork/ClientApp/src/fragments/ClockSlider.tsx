...
import type { IAnchorProps, IKnotInstance, IRoundClockProps, ITicksProps } from 'src/fragments/rndclktypes'
import { ClockPart, KnotPart, createStrokeFromKnots, getKnotsProps, getMaxRadius } from 'src/model'
import { type Vector2, mod } from 'mz-math'
import { RNDCLK_DF_KNOT_BORDER, RNDCLK_DF_KNOT_RADIUS, RNDCLK_DF_MAX, RNDCLK_DF_MIN, OUTLINENONE_CSS } from 'src/config/rndclk.constants'
import { numberOr, useMutationObserver, valueOr, useKnotStore } from 'src/utils'
import { checkAngleInArc, getClosestEdge, getSteppedAngle } from 'src/utils/geometries'
import { ClockFace } from './clockface'
import { TickMarks } from './tickmarks'
import { RopeLine } from './ropeline'
import { KnotDot } from './knotdot'
import { useResizeObserver } from '@mantine/hooks'
import { ReactComponent as ClockHandleSVG } from 'src/assets/image/ClockBallNeedle.svg'
import styled from '@emotion/styled'
import { keyframes } from '@emotion/react'

const ClockSlider = (props: IRoundClockProps) => {
