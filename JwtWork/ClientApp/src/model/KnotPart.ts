...
import type { IKnotBagInstance, IKnotInstance, IKnotProps, IKnotTemplateProps, IStrokeProps } from 'src/fragments/rndclktypes'
import { ClockPart } from './ClockPart'
import { type Vector2, type Vector3, circleMovement, convertRange, degreesToRadians, mod, v2Distance } from 'mz-math'
import { noEmptyOr, valueOr } from 'src/utils'
import {
